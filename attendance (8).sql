...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2020 at 07:35 PM
...
--
-- Table structure for table `197081`
--
...
INSERT INTO `logbook` (`id`, `customer_id`, `shop_id`, `location_id`, `time`) VALUES
(1, 42, 2, 2, '2020-09-25 07:33:08'),
(3, 43, 2, 2, '2020-09-29 18:42:14'),
(5, 42, 1, 1, '2020-10-02 15:24:26'),
(7, 43, 1, 1, '2020-10-09 05:57:42');
...
(43, 'Warlo Jesser Belandres', '09494431880', 'Tinampaan Street', '0eea59301b13804b68c44c568cf837af4e8ddf7e', 0, 'warlo jesser belandres.jpg', '3', '2020-09-26 01:00:25');
...
ALTER TABLE `logbook`
  ADD PRIMARY KEY (`id`),
  ADD KEY `forCustomerLogbook` (`customer_id`),
  ADD KEY `forCustomerShop` (`shop_id`),
  ADD KEY `forCustomerLocation` (`location_id`);
...
--
-- AUTO_INCREMENT for table `197081`
--
ALTER TABLE `197081`
...
--
ALTER TABLE `lecture`
  ADD CONSTRAINT `forLecturer` FOREIGN KEY (`lecturer`) REFERENCES `lecturer` (`id`),
...
--
ALTER TABLE `logbook`
  ADD CONSTRAINT `forCustomerLocation` FOREIGN KEY (`location_id`) REFERENCES `faculty` (`id`),
  ADD CONSTRAINT `forCustomerLogbook` FOREIGN KEY (`customer_id`) REFERENCES `student` (`id`),
  ADD CONSTRAINT `forCustomerShop` FOREIGN KEY (`shop_id`) REFERENCES `department` (`id`);
